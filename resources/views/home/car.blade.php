         ...
         <tbody><tr class=" active" gcode="52770" stock="18">
             ...
             <td width="57" class="bc_table_sel">
                ...
                <td width="257" class="bc_proname bc_name_gift">
                    <a href="http://thinkpad.lenovo.com.cn/product/52770.html" target="_blank">{{$car['goodsInfo']->title}}</a>
                    <br>

                </td>
                <td width="163"><a href="http://thinkpad.lenovo.com.cn/product/52770.html" target="_blank">{{$car['goodsInfo']->info}}</a></td>
             ...
             $tot+= $money;
             ?>
             <td width="152" id="money{{$car['goodsInfo']->id}}" class="bc_red">{{$money}}</td>
...
<div class="bc_num clearfix">
    ...
    <div class="bc_probtn clearfix">
        {{csrf_field()}}
        <input type="submit" id="submit" event-name="PC端_去结算" value="去结算">
